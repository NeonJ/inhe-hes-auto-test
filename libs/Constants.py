...
CommonDataTypes = {
    ...
    5: 'double-long',  # Integer32 -2 147 483 648…2 147 483 647
    6: 'double-long-unsigned',  # Unsigned32
    7: 'floating-poin',
    # Tag of the “floating-point” type in IEC 61334-4-41:1996, not usable in DLMS/COSEM. See tags [23] and [24]
    9: 'octet-string',  # An ordered sequence of octets (8 bit bytes)
    10: 'visible-string',  # An ordered sequence of ASCII characters
    11: 'time',  # Tag of the “time” type in IEC 61334-4-41:1996, not usable in DLMS/COSEM. See tag [27]
    12: 'utf8-string',  # An ordered sequence of characters encoded as UTF-8
    13: 'bcd',  # binary coded decimal
    15: 'integer',  # Integer8 -128…127
    16: 'long',  # Integer16 -32 768…32 767
    17: 'unsigned',  # Unsigned8 0…255
    18: 'long-unsigned',  # Unsigned16 0…65 535
    19: 'Compact array',  # Provides an alternative, compact encoding of complex data.
    20: 'long64',  # Integer64 - 263…263-1
    21: 'long64-unsigned',  # Unsigned64 0…264-1
    22: 'enum',
    ...
    23: 'float32',  # float32 [23] OCTET STRING (SIZE(4))
